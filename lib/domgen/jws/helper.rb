  ...
  module JWS
    module Helper
      ...
      def xsd_type(characteristic)
        ...
        return " type=\"#{Domgen::Naming.underscore(characteristic.referenced_struct.data_module.name)}:#{characteristic.referenced_struct.name}\"" if characteristic.struct?
        return " type=\"#{Domgen::Naming.underscore(characteristic.enumeration.data_module.name)}:#{characteristic.enumeration.name}\"" if characteristic.enumeration?
