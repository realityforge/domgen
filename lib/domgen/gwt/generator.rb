...
Domgen.template_set(:gwt_client_event) do |template_set|
  template_set.erb_template(Domgen::Generator::GWT::FACETS,
                            :message,
...
Domgen.template_set(:gwt_client_jso) do |template_set|
  template_set.erb_template(Domgen::Generator::GWT::FACETS + [:json],
                            :struct,
...
Domgen.template_set(:gwt_client_gwt_model_module) do |template_set|
  template_set.erb_template(Domgen::Generator::GWT::FACETS,
                            :repository,
