...
Domgen.template_set(:sync_core_ejb) do |template_set|
  template_set.erb_template(Domgen::Generator::Sync::FACETS,
                            :data_module,
...
Domgen.template_set(:sync_sql) do |template_set|
  template_set.erb_template(Domgen::Generator::Sync::FACETS + [:mssql],
                            :data_module,
...
Domgen.template_set(:sync_pgsql) do |template_set|
  template_set.erb_template(Domgen::Generator::Sync::FACETS + [:pgsql],
                            :data_module,
